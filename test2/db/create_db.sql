CREATE TABLE IF NOT EXISTS "building"(
    building_pk blob NOT NULL, -- Primary key for the building
...
CREATE TABLE IF NOT EXISTS "building_space"(
    building_space_pk blob NOT NULL, -- Primary key for the building space
    building_fk blob NOT NULL, -- Foreign key to the building table
...
CREATE TABLE IF NOT EXISTS "building_room"(
    building_room_pk blob NOT NULL, -- Primary key for the building room
    building_space_fk blob NOT NULL, -- Foreign key to the building space table
...
CREATE TABLE IF NOT EXISTS "drivers"(
    driver_pk blob NOT NULL, -- Primary key for the driver
    driver_type varchar(50) NOT NULL, -- Type of the driver
    CONSTRAINT driver_pk PRIMARY KEY (driver_pk)
);

CREATE TABLE IF NOT EXISTS "device"(
    device_pk blob NOT NULL, -- Primary key for the device
    room_fk blob NOT NULL, -- Foreign key to the building room table
    device_name varchar(255) NOT NULL, -- Name of the device
    device_type varchar(50) NOT NULL, -- Type of the device
    driver_fk blob NOT NULL, -- Foreign key to the drivers table
    driver_data json NOT NULL, -- JSON object containing the abilities of the device
...
CREATE TABLE IF NOT EXISTS "roles"(
    role_pk blob NOT NULL, -- Primary key for the role
...
CREATE TABLE IF NOT EXISTS "users"(
    user_pk blob NOT NULL, -- Primary key for the user
    ...
    fk_role blob NOT NULL, -- Foreign key to the roles table
